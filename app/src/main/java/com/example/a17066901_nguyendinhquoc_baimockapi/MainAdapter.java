...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    private ArrayList<User> getAllUser(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, "https://5fd478dde9cda40016f5c140.mockapi.io/ThucHanh/user", null, new Response.Listener<JSONArray>() {
            @Override
